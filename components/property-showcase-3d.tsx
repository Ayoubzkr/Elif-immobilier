...
export function PropertyShowcase3D({ images }: PropertyShowcase3DProps) {
  ...
  return (
    <div className="pro-surface relative overflow-hidden rounded-[30px] border border-white/70 bg-[linear-gradient(135deg,#fff8f1_0%,#f6ecdf_55%,#fff5eb_100%)] shadow-[0_30px_80px_-40px_rgba(15,23,42,0.45)]">
